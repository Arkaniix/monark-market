...
import { Search, Radar, Home, Eye, User, Menu, Calculator, Users, GraduationCap, LogOut, Shield, Scale, MessageCircle, Package, Wrench } from "lucide-react";
...
const navigation = [
  ...
  { name: "Réparation", href: "/repair", icon: Wrench },
