...
import { Gauge, CreditCard, Target, Bell, TrendingUp, Clock, CheckCircle, AlertCircle, PiggyBank, Eye } from "lucide-react";
    ...
    <section className="py-8">
      <div className="container">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Synthèse de tes analyses et activités Lens</p>
        </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  {recentActivity.slice(0, 5).map(activity => (
                    <div key={activity.id} className={`flex items-start gap-3 p-3 rounded-lg border ${getActivityBgColor(activity.type)}`}>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle>Analyses sur {timeFilter === '7j' ? '7' : timeFilter === '30j' ? '30' : '90'} jours</CardTitle>
                  </div>
                  <div className="flex items-center gap-1 p-1 rounded-md bg-muted">
                    <Button variant={timeFilter === '7j' ? 'default' : 'ghost'} size="sm" className="h-7 px-2" onClick={() => setTimeFilter('7j')}>7j</Button>
                    <Button variant={timeFilter === '30j' ? 'default' : 'ghost'} size="sm" className="h-7 px-2" onClick={() => setTimeFilter('30j')}>30j</Button>
                    <Button variant={timeFilter === '90j' ? 'default' : 'ghost'} size="sm" className="h-7 px-2" onClick={() => setTimeFilter('90j')}>90j</Button>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                ...
                <div className="flex items-center justify-center gap-6 mt-4 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">Analyses Lens</span>
                  </div>
                </div>
              </CardContent>
            </Card>
