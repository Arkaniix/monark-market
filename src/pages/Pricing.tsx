...
const FAQ_ITEMS = [
  {
    ...
    answer: "Non, les crédits sont remis à zéro à chaque nouveau cycle mensuel. Les crédits non utilisés et ceux gagnés via le scrap communautaire ne sont pas reportés au mois suivant.",
  },
  {
  ...
  {
    question: "Comment fonctionne le scrap communautaire ?",
    answer: "En participant aux missions de scrap communautaire, vous gagnez des crédits (jusqu'à 20 par mission). Ces crédits sont ajoutés à votre solde mais expirent aussi au reset mensuel.",
  },
  {
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8 space-y-16">
        ...
        {/* Final CTA */}
        <div className="text-center py-8 px-6 rounded-2xl bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 border">
          <h2 className="text-2xl font-bold mb-2">Prêt à commencer ?</h2>
          <p className="text-muted-foreground mb-4">
            Rejoignez des centaines d'utilisateurs qui maximisent leurs profits
          </p>
