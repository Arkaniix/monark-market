    ...
    queryFn: async () => {
      ...
      return {
        ...
        kpi: {
          ...
          var_7d_pct: model.market.var_7d_pct ?? null,
          var_30d_pct: model.market.var_30d_pct ?? null,
          var_90d_pct: model.market.var_90d_pct ?? null,
          fair_value_30d: model.market.fair_value_30d ?? null,
          volume_active: model.market.volume,
          liquidity_score: model.market.liquidity_score,
          rarity_index: Math.max(0, Math.min(1, 1 - (model.market.liquidity_score ?? (model.market.volume / 300)))),
